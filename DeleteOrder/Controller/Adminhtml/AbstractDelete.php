...
namespace CloudyDigitals\DeleteOrder\Controller\Adminhtml;
...
abstract class AbstractDelete extends \Magento\Backend\App\Action
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('CloudyDigitals_DeleteOrder::delete_order');
    }
